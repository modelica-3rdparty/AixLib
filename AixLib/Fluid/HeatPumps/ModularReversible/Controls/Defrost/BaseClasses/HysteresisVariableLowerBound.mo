...
block HysteresisVariableLowerBound "Hysteresis with a variable lower Boundary"
  extends Modelica.Blocks.Icons.PartialBooleanBlock;

  parameter Real uHigh(start=1) "If y=false and u>uHigh, switch to y=true";
  parameter Boolean pre_y_start=false "Value of pre(y) at initial time";

  Modelica.Blocks.Interfaces.RealInput uLow "Lower boundary of hysteresis curve" annotation (Placement(transformation(extent={{-140,
            -70},{-100,-30}})));
  Modelica.Blocks.Interfaces.RealInput u "Input variable" annotation (Placement(transformation(extent={{-140,20},
            {-100,60}})));
  Modelica.Blocks.Interfaces.BooleanOutput y "output Boolean" annotation (Placement(transformation(
